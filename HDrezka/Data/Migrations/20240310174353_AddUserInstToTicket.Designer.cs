...
namespace HDrezka.Migrations
{
    ...
    [Migration("20240310174353_AddUserInstToTicket")]
    partial class AddUserInstToTicket
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HDrezka.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HDrezka.Models.Seat", b =>
                {
                    b.HasOne("HDrezka.Models.MovieSchedule", null)
                        .WithMany("Seats")
            ...
            modelBuilder.Entity("HDrezka.Models.Ticket", b =>
                {
                    b.HasOne("HDrezka.Models.MovieSchedule", "MovieScheduleInst")
                        .WithMany("Tickets")
                        .HasForeignKey("MovieScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HDrezka.Models.User", "UserInst")
                        .WithMany()
                        .HasForeignKey("UserInstId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MovieScheduleInst");
